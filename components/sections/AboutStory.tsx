      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            <h2 className="font-space text-3xl font-bold text-ink md:text-4xl lg:text-5xl">
          ...
          >
            {/* Decorative ✦ */}
            <span className="absolute right-4 top-4 z-10 text-2xl text-accent opacity-70 select-none">
              ✦
            </span>
